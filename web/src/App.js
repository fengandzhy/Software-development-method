...
import { TeamFeelingCharts } from './components/TeamFeelingCharts';
import { PersonalFeelingCharts} from './components/PersonalFeelingCharts';
...
class App extends Component {
    ...
    createMenu() {
        this.menu = [
            ...
            {
                label: 'Dash Board', icon: 'pi pi-fw pi-home',
                items: [
                    // { label: 'Team Feelings', icon: 'pi pi-fw pi-bars', command: () => this.setState({ layoutMode: 'static' }) },
                    // { label: 'Individual Feelings', icon: 'pi pi-fw pi-bars', command: () => this.setState({ layoutMode: 'overlay' }) }
                    { label: 'Team Feelings', icon: 'pi pi-fw pi-bars', command: () => { window.location = "#/team-charts" } },
                    { label: 'Individual Feelings', icon: 'pi pi-fw pi-bars', command: () => { window.location = "#/personal-charts" } },
                    { label: 'Notification', icon: 'pi pi-fw pi-bars', command: () => { window.location = "#/notify" } }
                ]
            },
            // {
        ...
        return (
            <div className={wrapperClass} onClick={this.onWrapperClick}>
                ...
                <div className="layout-main">
                    <Route path="/" exact component={TeamFeelingCharts} />
                    <Route path="/team-charts" component={TeamFeelingCharts} />
                    <Route path="/notify" component={Notification} />
                    <Route path="/personal-charts" component={PersonalFeelingCharts} />
                </div>
